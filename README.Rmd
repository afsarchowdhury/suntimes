...
The data returned by {suntimes} is in POSIXct by default.  The [{hms}](https://hms.tidyverse.org/index.html) package can be used to extract the time, if that is all you want.
